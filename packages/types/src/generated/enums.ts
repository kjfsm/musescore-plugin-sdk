...
export const ElementType = {
  ...
  SOUND_FLAG: 55,
  PLAY_COUNT_TEXT: 56,
  PLAYTECH_ANNOTATION: 57,
  CAPO: 58,
  STRING_TUNINGS: 59,
  TRIPLET_FEEL: 60,
  REHEARSAL_MARK: 61,
  INSTRUMENT_CHANGE: 62,
  STAFFTYPE_CHANGE: 63,
  FRET_DIAGRAM: 64,
  HARMONY: 65,
  HARP_DIAGRAM: 66,
  ...
  TRILL_SEGMENT: 72,
  LET_RING_SEGMENT: 73,
  GRADUAL_TEMPO_CHANGE_SEGMENT: 74,
  VIBRATO_SEGMENT: 75,
  PALM_MUTE_SEGMENT: 76,
  WHAMMY_BAR_SEGMENT: 77,
  RASGUEADO_SEGMENT: 78,
  HARMONIC_MARK_SEGMENT: 79,
  PICK_SCRAPE_SEGMENT: 80,
  TEXTLINE_SEGMENT: 81,
  VOLTA_SEGMENT: 82,
  PEDAL_SEGMENT: 83,
  LYRICSLINE_SEGMENT: 84,
  PARTIAL_LYRICSLINE_SEGMENT: 85,
  GLISSANDO_SEGMENT: 86,
  NOTELINE_SEGMENT: 87,
  STAFF_VISIBILITY_INDICATOR: 88,
  SYSTEM_LOCK_INDICATOR: 89,
  SPACER: 90,
  STAFF_STATE: 91,
  NOTEHEAD: 92,
  NOTEDOT: 93,
