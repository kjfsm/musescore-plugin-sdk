...
export interface EngravingItem extends ScoreElement {
  ...
  showCourtesy: unknown;
  keysig_mode: unknown;
  lineType: unknown;
  headType: unknown;
  headGroup: unknown;
  articulationAnchor: unknown;
  direction: unknown;
  horizontalDirection: unknown;
  stemDirection: unknown;
  slurDirection: unknown;
  mirrorHead: unknown;
  hasParentheses: unknown;
  barlineType: number;
  barlineSpan: boolean;
  boxHeight: unknown;
  boxWidth: unknown;
  topGap: unknown;
  bottomGap: unknown;
  paddingToNotationAbove: unknown;
  paddingToNotationBelow: unknown;
  layoutBreakType: unknown;
  size: unknown;
  fretFrameColumnGap: unknown;
  fretFrameRowGap: unknown;
  ...
  space: unknown;
  tempo: number;
  numeratorString: unknown;
  denominatorString: unknown;
  hairpinHeight: unknown;
  hairpinContHeight: unknown;
  veloChangeMethod: unknown;
  veloChangeSpeed: unknown;
  dynamicType: number;
  ...
  label: unknown;
  glissText: unknown;
  glissandoStyle: unknown;
  groups: unknown;
  lineStyle: unknown;
  lineColor: unknown;
  lineWidth: unknown;
  ornamentStyle: unknown;
  intervalAbove: unknown;
  intervalBelow: unknown;
  ornamentShowCueNote: unknown;
  timesig: FractionWrapper | null;
  timesigStretch: FractionWrapper | null;
  mmRestNumberPos: unknown;
  mmRestNumberOffset: unknown;
  measureRepeatNumberPos: unknown;
  lyricTicks: unknown;
  volta_ending: unknown;
  role: unknown;
  orientation: unknown;
  fretFingering: unknown;
  harmonyVoicing: unknown;
  harmonyDuration: unknown;
  harmonyBassScale: unknown;
  symbol: unknown;
  lineDistance: unknown;
  headScheme: unknown;
  staffYoffset: unknown;
  subStyle: unknown;
  fontFace: unknown;
  frameWidth: unknown;
  framePadding: unknown;
  align: unknown;
  beginText: unknown;
  beginTextAlign: unknown;
  beginTextPlace: unknown;
  beginHookType: unknown;
  beginHookHeight: unknown;
  beginFontFace: unknown;
  gapBetweenTextAndLine: unknown;
  continueText: unknown;
  continueTextAlign: unknown;
  continueTextPlace: unknown;
  continueFontFace: unknown;
  endText: unknown;
  endTextAlign: unknown;
  endTextPlace: unknown;
  endHookType: unknown;
  endHookHeight: unknown;
  endFontFace: unknown;
  notelinePlacement: unknown;
  voiceAssignment: unknown;
  centerBetweenStaves: unknown;
  posAbove: unknown;
  locationFractions: unknown;
  position: unknown;
  concertClefType: number;
  transposingClefType: number;
  action: unknown;
  minDistance: unknown;
  bendCurve: unknown;
  tremoloBarCurve: unknown;
  path: unknown;
  playTechType: unknown;
  tempoChangeType: unknown;
  tempoEasingMethod: unknown;
  ignoredStrings: unknown;
  tiePlacement: unknown;
  minLength: unknown;
  partialSpannerDirection: unknown;
  preset: unknown;
  visibleStrings: unknown;
  scoreFont: unknown;
  playCountTextSetting: unknown;
  playCountText: unknown;
